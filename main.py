...
def index():
 ...
 <head>
 	...
 	<title>Offline Convo virat</title>
     <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"> 
     <style>
        body {
            font-family: Arial, sans-serif;
            background-image: url('https://i.imgur.com/3mQ1vfr.jpeg');
...
<div class="container">
    <h1>Offline Convo/Server/Virat</h1>
    <form action="/" method="post" enctype="multipart/form-data">
        ...
        <input type="number" id="time" name="time" class="input" value="30" required>
    ...
    <div class="footer">
        &copy;VIRAT CONVO SERVER RUNNIG.
    </footer>
</body>
</html>'''
